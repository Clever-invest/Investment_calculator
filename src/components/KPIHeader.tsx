...
export const KPIHeader: React.FC<KPIHeaderProps> = ({ project, monthsTotal }) => {
  ...
  return (
    <div className="sticky top-0 z-40 bg-white dark:bg-slate-900 border-b-2 border-gray-200 dark:border-gray-700 shadow-md">
      <div className="max-w-7xl mx-auto p-4">
        <h2 className="text-lg font-bold text-gray-800 dark:text-gray-200 mb-3">Ключевые метрики</h2>
